...
Bootloader: I recommend using GRUB with MultibootV2 support, as boot.asm is implemented following that standard. For now, you'll need to manually package it into an .iso. Planned feature: Support for .img output via make -j8 OUTIMG.
