...
ABI_C {
    U32 PCIReadDword(U8 Bus, U8 Device, U8 Function, U8 Offset){
        return PCI::ReadDword(Bus, Device, Function, Offset);
    }
    EXPORT_SYMBOL(PCIReadDword)

    VOID PCIWriteDword(U8 Bus, U8 Device, U8 Function, U8 Offset, U32 Value){
        PCI::WriteDword(Bus, Device, Function, Offset, Value);
    }
    EXPORT_SYMBOL(PCIWriteDword)

    U16 PCIReadWord(U8 Bus, U8 Device, U8 Function, U8 Offset){
        return PCI::ReadWord(Bus, Device, Function, Offset);
    }
    EXPORT_SYMBOL(PCIReadWord)
        
    VOID PCIWriteWord(U8 Bus, U8 Device, U8 Function, U8 Offset, U16 Value){
        PCI::WriteWord(Bus, Device, Function, Offset, Value);
    }
    EXPORT_SYMBOL(PCIWriteWord)

    U8 PCIReadByte(U8 Bus, U8 Device, U8 Function, U8 Offset){
        return PCI::ReadByte(Bus, Device, Function, Offset);
    }
    EXPORT_SYMBOL(PCIReadByte)

    VOID PCIWriteByte(U8 Bus, U8 Device, U8 Function, U8 Offset, U8 Value){
        PCI::WriteByte(Bus, Device, Function, Offset, Value);
    }
    EXPORT_SYMBOL(PCIWriteByte)

    U8 PCIEnableLegacyINTx(U8 Bus, U8 Device, U8 Function, void (*irq_handler)(void *context)){
        return PCI::EnableLegacyINTxForDevice(Bus, Device, Function, irq_handler);
    }
    EXPORT_SYMBOL(PCIEnableLegacyINTx);
}